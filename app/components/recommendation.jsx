...
const RecCar = () => {
    return (
        ...
        <div className="flex justify-between">
          ...
          <div className="max-w-xs h-[388px] bg-white rounded-lg overflow-hidden shadow-lg flex flex-col">
            ...
            <div className="p-4">
              ...
              <div className="flex justify-between items-center w-[304px] px-5 mt-6">
                ...
                <div><div className="w-[304px] flex items-center justify-center">
          <div className="max-w-xs h-[388px] bg-white rounded-lg overflow-hidden shadow-lg flex flex-col">
            {/* Title Section */}
            <div className="p-4">
              <div className="flex justify-between items-center w-[304px] px-5">
          ...
          <div className="max-w-xs h-[388px] bg-white rounded-lg overflow-hidden shadow-lg flex flex-col">
            ...
            <div className="p-4">
              <div className="flex justify-between items-center w-[304px] px-5">
                <div>
                  <h2 className="text-lg font-bold text-gray-900">All New Terios</h2>
                  <p className="text-sm text-gray-500">SUV</p>
                </div>
                <button className="text-red-500 hover:text-red-600">
                  <svg
          ...
          <div className="max-w-xs h-[388px] bg-white rounded-lg overflow-hidden shadow-lg flex flex-col">
            ...
            <div className="p-4">
              <div className="flex justify-between items-center w-[304px] px-5">
                <div>
                  <h2 className="text-lg font-bold text-gray-900">MG ZX Exclusice</h2>
          ...
          <div className="max-w-xs h-[388px] bg-white rounded-lg overflow-hidden shadow-lg flex flex-col">
            ...
            <div className="p-4">
              <div className="flex justify-between items-center w-[304px] px-5">
                <div>
                  <h2 className="text-lg font-bold text-gray-900">New MG ZS</h2>
                  <p className="text-sm text-gray-500">SUV</p>
                </div>
                <button className="text-red-500 hover:text-red-600">
                  <svg
          ...
          <div className="max-w-xs h-[388px] bg-white rounded-lg overflow-hidden shadow-lg flex flex-col">
            ...
            <div className="p-4">
              <div className="flex justify-between items-center w-[304px] px-5">
                <div>
                  <h2 className="text-lg font-bold text-gray-900">MG ZX Excite</h2>
                  <p className="text-sm text-gray-500">Hatchback</p>
                </div>
                <button className="text-red-500 hover:text-red-600">
                  <svg
        ...
        <div className="flex justify-between">
        <div></div>
        <div><Link href='/Dashboard'><Button className="bg-[#3563E9] text-white mb-32">Show more cars</Button></Link></div>
